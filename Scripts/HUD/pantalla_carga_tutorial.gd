#Gestiona la escena de transicion hacia el tutorial
...
var escena_nivel_juego = "res://Escenas/Nivel/Tutorial.tscn"
...
#Simula la carga de recursos usando Tween para animar la barra de progreso
